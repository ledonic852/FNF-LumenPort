function onCreate()
    if lowQuality == false then
        ...
        for i, object in ipairs({'highway', 'traffic'}) do
            setBlendMode(object..'Lights_lightmap', 'ADD')
            setProperty(object..'Lights_lightmap.alpha', 0.6)
        end
    end
end
...
-- Everything from this point is where you can see how the cars and traffic light work.
isRedLight = false
lastChange = 0
changeInterval = 8
