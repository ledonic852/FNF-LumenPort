...
function onCreatePost()
    addLuaScript('characters/props/speaker-tankmen')
    callScript('characters/props/speaker-tankmen', 'createSpeaker', {'gf-tankmen', -190, 314}) -- {characterName, offsetX, offsetY}
end
...
function goodNoteHit(membersIndex, noteData, noteType, isSustainNote)
    if gfComboAnim ~= 'none' then
        if gfComboAnim == 'vanilla' then
            if combo == 50 then
                --[[ 
                Temporary removal, since she doesn' have her "cheer" anim.
                TODO: Maybe add back the animation?
